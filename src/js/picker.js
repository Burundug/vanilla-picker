...
class Picker {
     ...
     * @param {function}     [options.onInit]         - @see {@linkcode Picker#onInit|onInit}
    ...
    setOptions(options) {
        ...
        if (options instanceof HTMLElement) {
            ...
            if(options.alias) {
                ...
                if(options.parent) {
                let nameHolder = options.parent.parentNode.nextElementSibling
    ...
    show() {
        ...
        if(!this.settings.tonal) {
            this._pickerTonal.style.display = 'none';
        }
    ...
    _bindEvents() {
        ...
        addEvent(dom, 'click', e => {
            ...
            if (target !== this._pickerTonal && !this._pickerTonal.contains(target)) {
                e.preventDefault()
            }
        });
        ...
        addEvent(this._alias,'input',  (e) => {
            if (this.onChangeAlias) {
                this.onChangeAlias(e.target.value.length ? e.target.value : this.cl_id);
            }
        })
